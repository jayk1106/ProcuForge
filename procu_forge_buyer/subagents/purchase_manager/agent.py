...
|-----------|--------------|
| VENDOR_SELECTED | Call **send_rfq_closed_to_losing_vendors** — no arguments needed; notifies all non-selected vendors. The callback will advance status automatically. |
| AWAITING_USER_APPROVAL | Call **approve_po** — no arguments needed; advances to PO_ISSUED so the PO can be sent on the next turn. |
